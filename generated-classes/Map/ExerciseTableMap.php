...
class ExerciseTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ExerciseTableMap::COL_ID, ExerciseTableMap::COL_NAME, ExerciseTableMap::COL_TYPE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ExerciseTableMap::COL_ID => 0, ExerciseTableMap::COL_NAME => 1, ExerciseTableMap::COL_TYPE => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ExerciseTableMap::COL_TYPE);
        } else {
