...
abstract class Exercise implements ActiveRecordInterface
{
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[ExerciseTableMap::COL_TYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ExerciseTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ExerciseTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExerciseTableMap::COL_TYPE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExerciseTableMap::COL_TYPE)) {
            $criteria->add(ExerciseTableMap::COL_TYPE, $this->type);
        }
