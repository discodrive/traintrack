 ...
 * @method     ChildExerciseQuery orderByType($order = Criteria::ASC) Order by the type column
 *
 * @method     ChildExerciseQuery groupById() Group by the id column
 * @method     ChildExerciseQuery groupByName() Group by the name column
 * @method     ChildExerciseQuery groupByType() Group by the type column
 *
 ...
 * @method     ChildExercise findOneByType(string $type) Return the first ChildExercise filtered by the type column *
 ...
 * @method     ChildExercise requireOneByType(string $type) Return the first ChildExercise filtered by the type column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildExercise[]|ObjectCollection findByType(string $type) Return ChildExercise objects filtered by the type column
...
abstract class ExerciseQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, type FROM exercise WHERE id = :p0';
        try {
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ExerciseTableMap::COL_TYPE, $type, $comparison);
    }
